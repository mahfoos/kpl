...
/** Static roster + tuning served to client apps (the separate admin). */
...
export interface TimelineStep {
  ...
  description: string;
  date: string;
  status: "completed" | "upcoming" | "final";
  icon: string;
}
...
export interface Sponsor {
  id: string;
  name: string;
  /** Free-form partnership label, e.g. "Digital, Software & Media Partner". */
  tier: string;
  initials: string;
}
